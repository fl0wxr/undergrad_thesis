...
## Stage 1 model evaluation history file path
...
if model_type == "CNN-static":
    ...
    a = Embedding(len(vocabulary_inv), embedding_dim, input_length=sequence_length, name="embedding")(a0)

a = Dropout(dropout_prob[0])(a)

## Convolutional block
conv_blocks = []
for sa in filter_sizes:
    conv = \
    Convolution1D\
    (
        filters=num_filters,
...
a = Concatenate()(conv_blocks) if len(conv_blocks) > 1 else conv_blocks[0]

a = Dropout(dropout_prob[1])(a)
a = Dense(hidden_dims, activation="relu")(a)
a = Dense(1, activation="sigmoid")(a)

src_model = Model(a0, a)
src_model.compile\
(
...
if model_type == "CNN-non-static":
    ...
    embedding_layer = src_model.get_layer("embedding")
