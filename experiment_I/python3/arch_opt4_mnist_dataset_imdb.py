...
## Output model
model_name = 'arch_opt4_mnist_dataset_imdb'
...
model.add(Embedding(len(vocabulary_inv), embedding_dim, input_length=sequence_length, name="embedding_", input_shape=input_shape))
...
if model_type == "CNN-non-static":
    ...
    embedding_layer = model.get_layer(name="embedding_")
